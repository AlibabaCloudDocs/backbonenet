...
3.  配置云企业网实例：
    ...
    -   **加载网络实例**：
        ...
        -   **实例**：选择要加载的实例。本操作选择一个VPC实例。
            ...
            ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3044/1537882770859_zh-CN.png)
...
1.  在云企业网实例页面，单击已创建的云企业网实例的**操作**列下的**管理**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3044/1537882770860_zh-CN.png)
...
2.  在**加载网络实例**页面，单击**加载网络实例**，配置网络实例：
    ...
    -   **实例**：选择要加载的实例。本操作选择一个VPC实例。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/3044/15378827705956_zh-CN.png)
